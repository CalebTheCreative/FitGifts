						...
						<Col sm="auto">
							...
							<Modal show={show2} onHide={handleClose2}>
								...
								<Modal.Body>
									<Col sm="auto">
										<Button
											className="my-1 btn-block btn-lg"
										...
										<Button
											className="my-1 btn-block btn-lg"
											variant="outline-secondary"
											href="sms:123-456-7890"
										>
											<i className="fas fa-comment-dots"></i>&nbsp;Text
										</Button>
										<Button
											className="my-1 btn-block btn-lg"
											variant="outline-secondary"
									...
									<Modal show={show3} onHide={handleClose3}>
										...
										<Modal.Body>
											<Row className="justify-content-center">
												<Col
													sm={12}
													className="text-center justify-content-center bg-secondary"
												>
													...
													<Row className="justify-content-center">
														...
														<Col sm={10}>
															<p className="text-left">
																Every month w/ 4 completed sessions
															</p>
														</Col>
													</Row>
												</Col>
