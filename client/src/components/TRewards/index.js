...
function TRewards() {
    ...
    function handleSubmit(e) {
        ...
        if (formObject.rwdName && formObject.rwdVal) {
            API.createReward({
                rwdName: formObject.rwdName,
                rwdVal: formObject.rwdVal
            })
                        ...
                        <Col sm={12} className="justify-content-center">
                            <form>
                                <Row className="justify-content-center">
                                    ...
                                    <Col sm={4}>
                                        <button
                                            disabled={!(formObject.rwdName && formObject.rwdVal)}
