                    ...
                    <Container id="t-home-banner1" className="px-4 py-4">
                        ...
                        <Row>
                            <Col>
                                ...
                                <h5 className="text-danger">Trainer Number: <Button size="sm" href="sms:&body=Enter code '12345' to add me as your trainer on FitGifts!">{this.state.actNum}</Button> </h5>
