        ...
        return (
            <div>
                ...
                <Container className="text-center justify-content-center">
                    ...
                    <br />
                    <Row className="cbox justify-content-center">
                        <Image src="/images/background/bell-1.png" className="c-session-bg" />
                        <Container className="cbox-text justify-content-center align-items-center">
